...
/*          Matthew Austin           */
/*-----------------------------------*/
libname logistic "D:\Logistic_Regression\data";
...
proc logistic data=logistic.lowbwt;
	...
	estimate 'black smoker vs white nonsmoker' intercept 1 age 30 lwt 130 race 0 0 smoke 1,
							   				   intercept 1 age 30 lwt 130 race 0 1 smoke 0,
							   				   race 0 1 smoke -1 / e exp cl;
